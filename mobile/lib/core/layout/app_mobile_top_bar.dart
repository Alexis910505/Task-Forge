...
class AppMobileTopBar extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final onNotifications = GoRouterState.of(context).uri.path == '/notifications';
        ...
        children: [
          ...
          IconButton(
            ...
            icon: Badge(
              ...
              child: Icon(
                onNotifications ? Icons.notifications : Icons.notifications_outlined,
                color: onNotifications ? scheme.primary : scheme.onSurfaceVariant,
              ),
            ),
          ),
          IconButton(
